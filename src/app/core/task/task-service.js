 ...
 * @param Task
 * @returns {{tasks: Array, getTasks: Function, createTask: Function, deleteTask: Function, newTask: Function, updateTask: Function}}
 */
function TaskService($q, $localStorage, localStorageKey, Task) {
  var service = {
